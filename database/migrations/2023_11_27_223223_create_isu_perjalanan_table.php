...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('isu_perjalanan', function (Blueprint $table) {
            ...
            $table->timestamp('waktu_pelaporan')->nullable(); // Tanggal pelaporan isu perjalanan
            $table->timestamp('waktu_penyelesaian')->nullable(); // Tanggal penyelesaian isu perjalanan
            $table->boolean('status')->default(true); // Status isu perjalanan (dalam penanganan atau sudah selesai)
            $table->timestamps();
        });
    }
