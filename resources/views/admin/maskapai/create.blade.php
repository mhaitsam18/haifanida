    ...
    <div class="grid gap-6 lg:grid-cols-3">
        <x-card class="lg:col-span-2">
            <form action="/admin/maskapai" method="post" enctype="multipart/form-data">
                @csrf
                <x-form-input label="Kode Maskapai" name="kode_maskapai" :value="old('kode_maskapai')" placeholder="Kode Maskapai" />
                <x-form-input label="Nama Maskapai" name="nama_maskapai" :value="old('nama_maskapai')" placeholder="Nama Maskapai" />
                <x-form-input label="Negara Asal" name="negara_asal" :value="old('negara_asal')" placeholder="Negara Asal" />
        ...
        <x-card title="Pratinjau Logo">
            <img src="" alt="" class="img-preview aspect-4/3 w-full rounded-lg object-contain">
        </x-card>
    </div>
@endsection
