...
@section('content')
    <div x-data="modalForm()">
        ...
        <x-modal title="Tambah Berkas">
            <form action="/admin/berkas" method="post" @submit="submit">
                @csrf
                <x-form-input label="Nama Berkas" name="nama_berkas" placeholder="Nama Berkas" />
                <x-form-error name="nama_berkas" />
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2" x-data="modalForm()">
                                ...
                                <x-modal title="Edit Berkas">
                                    <form action="/admin/berkas/{{ $berkas->id }}" method="post" @submit="submit">
                                        @method('put')
                                        @csrf
                                        <x-form-input label="Nama Berkas" name="nama_berkas" :value="$berkas->nama_berkas" placeholder="Nama Berkas" />
                                        <x-form-error name="nama_berkas" />
