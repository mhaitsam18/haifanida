                    ...
                    <div class="d-flex justify-content-between align-items-baseline mb-2">
                        ...
                        <div class="dropdown mb-2">
                            ...
                            <div class="dropdown-menu" aria-labelledby="tambah">
                                <a class="dropdown-item d-flex align-items-center" href="/admin/berkas/create"><i
                                        data-feather="plus" class="icon-sm me-2"></i> <span class="">Tambah</span></a>
                            </div>
                        </div>
                    </div>
                    <a class="btn btn-sm btn-haifa my-2" href="/admin/berkas/create"><i data-feather="plus"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <a href="/admin/berkas/{{ $berkas->id }}/edit"
                                                    class="badge bg-success d-inline-block m-1">Edit</a>
                                                <form action="/admin/berkas/{{ $berkas->id }}" method="post">
                                                    @method('delete')
                                                    @csrf
                                                    <button type="submit"
