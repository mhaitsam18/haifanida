        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/cabang/{{ $cabang->id }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $cabang->id }}">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('nama_cabang') is-invalid @enderror"
                                        ...
                                        value="{{ old('nama_cabang', $cabang->nama_cabang) }}" placeholder="Nama Cabang">
                                    @error('nama_cabang')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('perwakilan_id') is-invalid @enderror"
                                        ...
                                        @foreach ($perwakilans as $perwakilan)
                                            <option value="{{ $perwakilan->id }}" @selected($perwakilan->id == old('perwakilan_id', $cabang->perwakilan_id))>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('kontak') is-invalid @enderror"
                                        id="kontak" name="kontak" value="{{ old('kontak', $cabang->kontak) }}"
                                        placeholder="Kontak">
                                    @error('kontak')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control  @error('surat_izin') is-invalid @enderror"
                                        ...
                                        value="{{ old('surat_izin', $cabang->surat_izin) }}" placeholder="Surat Izin">
                                    @error('surat_izin')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('kantor_id') is-invalid @enderror" id="kantor_id"
                                        name="kantor_id" value="{{ old('kantor_id', $cabang->kantor_id) }}"
                                        placeholder="Kantor">
                                        <option value="" selected disabled>Pilih Kantor</option>
                                        @foreach ($kantors as $kantor)
                                            <option value="{{ $kantor->id }}" @selected($kantor->id == old('kantor_id', $cabang->kantor_id))>
                                                {{ $kantor->nama_kantor }} |
