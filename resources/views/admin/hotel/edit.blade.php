                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('kode_hotel') is-invalid @enderror"
                                        id="kode_hotel" name="kode_hotel"
                                        value="{{ old('kode_hotel', $hotel->kode_hotel) }}" placeholder="Kode Hotel">
                                    @error('kode_hotel')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('nama_hotel') is-invalid @enderror"
                                        id="nama_hotel" name="nama_hotel"
                                        value="{{ old('nama_hotel', $hotel->nama_hotel) }}" placeholder="Nama Hotel">
                                    @error('nama_hotel')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="bintang_setaraf" name="bintang_setaraf"
                                        value="{{ old('bintang_setaraf', $hotel->bintang_setaraf) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('kota') is-invalid @enderror"
                                        id="kota" name="kota" value="{{ old('kota', $hotel->kota) }}"
                                        placeholder="Kota">
                                    @error('kota')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('negara') is-invalid @enderror"
                                        id="negara" name="negara" value="{{ old('negara', $hotel->negara) }}"
                                        placeholder="Negara">
                                    @error('negara')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control  @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                        placeholder="Alamat">{{ old('alamat', $hotel->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control  @error('link_gmaps') is-invalid @enderror"
                                        ...
                                        value="{{ old('link_gmaps', $hotel->link_gmaps) }}" placeholder="Link Gmaps">
                                    @error('link_gmaps')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control  @error('deskripsi') is-invalid @enderror" id="deskripsi"
                                        name="deskripsi" placeholder="deskripsi">{{ old('deskripsi', $hotel->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file" class="form-control  @error('gambar') is-invalid @enderror"
                                        id="gambar" name="gambar" value="{{ old('gambar', $hotel->gambar) }}"
                                        placeholder="Gambar">
                                    @error('gambar')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
