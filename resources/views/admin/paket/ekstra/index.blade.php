...
@section('content')
    <x-page-header :title="$title">
        <x-slot:actions>
            <x-button :href="'/admin/paket/' . $paket->id . '/paket-ekstra/create'"><i class="bx bx-plus"></i> Tambah</x-button>
                    ...
                    <tr x-show="q === '' || $el.innerText.toLowerCase().includes(q.toLowerCase())">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2">
                                <a href="/admin/paket-ekstra/{{ $paketEkstra->id }}/edit" class="rounded-md bg-emerald-50 px-2.5 py-1 text-xs font-medium text-emerald-700 hover:bg-emerald-100">Edit</a>
