        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/bus/{{ $bus->id }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $bus->id }}">
                        <input type="hidden" name="paket_id" id="paket_id" value="{{ $bus->paket_id }}">
                        {{-- <input type="hidden" name="user_id" id="user_id" value="{{ $bus->user_id }}"> --}}
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nomor_rombongan" name="nomor_rombongan"
                                        value="{{ old('nomor_rombongan', $bus->nomor_rombongan) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nomor_polisi') is-invalid @enderror"
                                        ...
                                        value="{{ old('nomor_polisi', $bus->nomor_polisi) }}" placeholder="Nomor Polisi">
                                    @error('nomor_polisi')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('merek') is-invalid @enderror"
                                        id="merek" name="merek" value="{{ old('merek', $bus->merek) }}"
                                        placeholder="Merek / PO">
                                    @error('merek')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('kapasitas') is-invalid @enderror"
                                        id="kapasitas" name="kapasitas" value="{{ old('kapasitas', $bus->kapasitas) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control  @error('fasilitas') is-invalid @enderror" id="fasilitas" name="fasilitas"
                                        placeholder="Fasilitas">{{ old('fasilitas', $bus->fasilitas) }}</textarea>
                                    @error('fasilitas')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <a href="/admin/paket/{{ $bus->paket_id }}/bus"
