        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/penumpang/{{ $penumpang->id }}" method="post" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $penumpang->id }}">
                        <input type="hidden" name="bus_id" id="bus_id" value="{{ $penumpang->bus_id }}">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('jemaah_id') is-invalid @enderror" id="jemaah_id"
                                        ...
                                        @foreach ($jemaahs as $jemaah)
                                            <option value="{{ $jemaah->id }}" @selected(old('jemaah_id', $penumpang->jemaah_id) == $jemaah->id)>
                                                {{ $jemaah->nama_lengkap }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('nomor_kursi') is-invalid @enderror"
                                        ...
                                        value="{{ old('nomor_kursi', $penumpang->nomor_kursi) }}" placeholder="Nomor Kursi">
                                    @error('nomor_kursi')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <a href="/admin/bus/{{ $penumpang->bus_id }}/penumpang"
