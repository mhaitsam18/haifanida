                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number"
                                        ...
                                        value="{{ old('jumlah_pembayaran') }}" placeholder="Jumlah Pembayaran">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('metode_pembayaran') }}" placeholder="(Transfer / QRIS / dll.)">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_pembayaran') }}" placeholder="Tanggal Pembayaran">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="file"
                                        ...
                                        id="bukti_pembayaran" name="bukti_pembayaran" value="{{ old('bukti_pembayaran') }}">
                                ...
                                <a href="/admin/{{ $pemesanan ? 'pemesanan/' . $pemesanan->id . '/' : '' }}pembayaran"
