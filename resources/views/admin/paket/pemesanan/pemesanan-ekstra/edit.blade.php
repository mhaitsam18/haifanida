            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/pemesanan-ekstra/{{ $pemesananEkstra->id }}" method="post"
                        ...
                        @method('put')
                        @csrf
                        <input type="hidden" name="id" id="id" value="{{ $pemesananEkstra->id }}">
                        <input type="hidden" name="pemesanan_id" id="pemesanan_id"
                            value="{{ $pemesananEkstra->pemesanan_id }}">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('ekstra') is-invalid @enderror" id="ekstra"
                                        ...
                                        @foreach ($ekstras as $ekstra)
                                            <option value="{{ $ekstra->nama_ekstra }}"
                                                ...
                                                data-keterangan="{{ $ekstra->keterangan }}" @selected($ekstra->nama_ekstra == old('ekstra', $pemesananEkstra->ekstra))>
                                                {{ $ekstra->nama_ekstra }} |
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jumlah') is-invalid @enderror"
                                        id="jumlah" name="jumlah" value="{{ old('jumlah', $pemesananEkstra->jumlah) }}"
                                        placeholder="Jumlah">
                                    @error('jumlah')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('total_harga') is-invalid @enderror"
                                        ...
                                        value="{{ old('total_harga', $pemesananEkstra->total_harga) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan"
                                        placeholder="Keterangan">{{ old('keterangan', $pemesananEkstra->keterangan) }}</textarea>
                                    @error('keterangan')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <a href="/admin/{{ $pemesananEkstra->pemesanan_id ? 'pemesanan/' . $pemesananEkstra->pemesanan_id . '/' : '' }}pemesanan-ekstra"
