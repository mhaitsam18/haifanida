                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('jumlah_orang') is-invalid @enderror"
                                        id="jumlah_orang" name="jumlah_orang" value="{{ old('jumlah_orang') }}"
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('is_pembayaran_lunas') is-invalid @enderror"
                                            ...
                                            name="is_pembayaran_lunas" @checked(old('is_pembayaran_lunas'))>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_pelunasan') }}" placeholder="Tanggal Pelunasan">
