        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/penginapan" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('hotel_id') is-invalid @enderror" id="hotel_id"
                                        ...
                                        @foreach ($hotels as $hotel)
                                            <option value="{{ $hotel->id }}" @selected($hotel->id == old('hotel_id'))>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nomor_reservasi" name="nomor_reservasi" value="{{ old('nomor_reservasi') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        id="tanggal_check_in" name="tanggal_check_in" value="{{ old('tanggal_check_in') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_check_out') }}" placeholder="Tanggal Check Out">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control  @error('keterangan_hotel') is-invalid @enderror" id="keterangan_hotel"
                                        name="keterangan_hotel" placeholder="Keterangan Hotel">{{ old('keterangan_hotel') }}</textarea>
                                ...
                                <a href="/admin/paket/{{ $paket->id }}/penginapan"
