        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/admin/kamar/{{ $kamar->id }}/kamar-jemaah/create" class="btn btn-sm btn-langit mb-3"><i
                            data-feather="plus" class="icon-sm me-2"></i> Tambah Data Penghuni</a>
                    <a href="/admin/penginapan/{{ $kamar->paket_hotel_id }}" class="btn btn-sm btn-secondary mb-3"><i
                            ...
                            <tbody>
                                @foreach ($kamar->KamarJemaahs as $tamu)
                                    <tr>
                                        ...
                                        <td>{{ $tamu->jemaah->nama_lengkap }}</td>
                                        <td>
