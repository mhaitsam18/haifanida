                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('nomor_kamar') is-invalid @enderror"
                                        ...
                                        value="{{ old('nomor_kamar', $kamar->nomor_kamar) }}" placeholder="Nomor Kamar">
                                    @error('nomor_kamar')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control  @error('kapasitas') is-invalid @enderror"
                                        id="kapasitas" name="kapasitas" value="{{ old('kapasitas', $kamar->kapasitas) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control  @error('fasilitas') is-invalid @enderror" id="fasilitas" name="fasilitas"
                                        placeholder="Fasilitas">{{ old('fasilitas', $kamar->fasilitas) }}</textarea>
                                    @error('fasilitas')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input @error('tersedia') is-invalid @enderror"
                                            ...
                                            @checked(old('tersedia', $kamar->tersedia))>
                                ...
                                <a href="/admin/penginapan/{{ $kamar->paket_hotel_id }}/kamar"
