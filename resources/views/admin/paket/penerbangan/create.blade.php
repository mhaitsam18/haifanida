        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/penerbangan" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('maskapai_id') is-invalid @enderror" id="maskapai_id"
                                        ...
                                        @foreach ($maskapais as $maskapai)
                                            <option value="{{ $maskapai->id }}" @selected($maskapai->id == old('maskapai_id'))>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nomor_penerbangan') }}" placeholder="Nomor Penerbangan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('nomor_pnr') is-invalid @enderror"
                                        id="nomor_pnr" name="nomor_pnr" value="{{ old('nomor_pnr') }}" placeholder="PNR">
                                    @error('nomor_pnr')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('kelas') is-invalid @enderror"
                                        id="kelas" name="kelas" value="{{ old('kelas') }}" placeholder="Kelas">
                                    @error('kelas')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control  @error('kuota') is-invalid @enderror"
                                        id="kuota" name="kuota" value="{{ old('kuota') }}" placeholder="Kuota">
                                    @error('kuota')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control  @error('keterangan_penerbangan') is-invalid @enderror" id="keterangan_penerbangan"
                                        name="keterangan_penerbangan" placeholder="Keterangan Penerbangan">{{ old('keterangan_penerbangan') }}</textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('bandara_asal') is-invalid @enderror"
                                        id="bandara_asal" name="bandara_asal" value="{{ old('bandara_asal') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="bandara_tujuan" name="bandara_tujuan" value="{{ old('bandara_tujuan') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local"
                                        ...
                                        value="{{ old('waktu_keberangkatan') }}" placeholder="Waktu Keberangkatan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local"
                                        ...
                                        value="{{ old('waktu_kedatangan') }}" placeholder="Waktu Kedatangan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select  @error('status_penerbangan') is-invalid @enderror"
                                        ...
                                        <option value="On Schedule" @selected(old('status_penerbangan') == 'On Schedule')>On Schedule</option>
                                        <option value="Delay" @selected(old('status_penerbangan') == 'Delay')>Delay</option>
                                        <option value="Canceled" @selected(old('status_penerbangan') == 'Canceled')>Canceled</option>
                                        <option value="Emergency Landing" @selected(old('status_penerbangan') == 'Emergency Landing')>Emergency Landing
                                        </option>
                                        <option value="Failed" @selected(old('status_penerbangan') == 'Failed')>Failed</option>
                                        <option value="Landed Safely" @selected(old('status_penerbangan') == 'Landed Safely')>Landed Safely</option>
                                        <option value="Accident" @selected(old('status_penerbangan') == 'Accident')>Accident</option>
                                        <option value="Crash" @selected(old('status_penerbangan') == 'Crash')>Crash</option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('gate_penerbangan') }}" placeholder="Gate Penerbangan">
                                ...
                                <a href="/admin/paket/{{ $paket->id }}/penerbangan"
