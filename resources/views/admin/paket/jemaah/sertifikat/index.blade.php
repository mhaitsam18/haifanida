        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="/admin/jemaah/{{ $jemaah->id }}/sertifikat/create" class="btn btn-sm btn-langit mb-3"><i
                            data-feather="plus" class="icon-sm me-2"></i> Tambah Data sertifikat</a>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-3" id="dataTableExample">
                            <thead>
                                <tr>
                                    <th class="pt-0">#</th>
                            ...
                            <tbody>
                                @foreach ($sertifikatJemaahs as $sertifikat)
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('storage/' . $sertifikat->sertifikat) }}" alt=""
