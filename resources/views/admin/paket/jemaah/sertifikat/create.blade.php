                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_penerbitan') }}" placeholder="Tanggal Penerbitan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="jenis_sertifikat" name="jenis_sertifikat" value="{{ old('jenis_sertifikat') }}"
                                ...
                                @if ($jemaah)
                                    <a href="/admin/jemaah/{{ $jemaah->id }}/sertifikat"
                                        class="btn btn-secondary float-end m-2">Kembali</a>
                                @elseif($sertifikat)
                                    <a href="/admin/sertifikat/{{ $sertifikat->id }}"
                                        class="btn btn-secondary float-end m-2">Kembali</a>
                                @endif
                            </div>
                        </div>
