                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('provinsi_id') is-invalid @enderror" id="provinsi_id"
                                        ...
                                        @foreach ($provinsis as $provinsi)
                                            <option value="{{ $provinsi->id }}" @selected($provinsi->id == old('provinsi_id', $jemaah->provinsi_id))>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('kabupaten_id') is-invalid @enderror" id="kabupaten_id"
                                        ...
                                        @foreach ($kabupatens as $kabupaten)
                                            <option value="{{ $kabupaten->id }}" @selected($kabupaten->id == old('kabupaten_id', $jemaah->kabupaten_id))>
