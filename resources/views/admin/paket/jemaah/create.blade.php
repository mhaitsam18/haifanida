                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('grup_id') is-invalid @enderror" id="grup_id"
                                        ...
                                        @foreach ($grups as $grup)
                                            <option value="{{ $grup->id }}" @selected($grup->id == old('grup_id'))>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('hubungan_mahram') is-invalid @enderror"
                                        ...
                                        <option value="Ayah" @selected(old('hubungan_mahram') == 'Ayah')>Ayah</option>
                                        <option value="Anak" @selected(old('hubungan_mahram') == 'Anak')>Anak</option>
                                        <option value="Suami" @selected(old('hubungan_mahram') == 'Suami')>Suami</option>
                                        <option value="Saudara Kandung" @selected(old('hubungan_mahram') == 'Saudara Kandung')>Saudara Kandung
                                        </option> Kandung
                                        <option value="Kakek" @selected(old('hubungan_mahram') == 'Kakek')>Kakek</option>
                                        <option value="Cucu" @selected(old('hubungan_mahram') == 'Cucu')>Cucu</option>
                                        <option value="Paman" @selected(old('hubungan_mahram') == 'Paman')>Paman</option>
                                        <option value="Keponakan" @selected(old('hubungan_mahram') == 'Keponakan')>Keponakan</option>
                                    </select>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_sesuai_paspor') }}" placeholder="Nama Sesuai Paspor">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat"
                                        placeholder="Detail Alamat">{{ old('alamat') }}</textarea>
                                    @error('alamat')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="" id="tingkat_pendidikan">
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'SD')>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'SLTP')>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'SLTA')>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'D1/D2/D3')>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'D4/S1')>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'S2')>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input
                                                ...
                                                @checked(old('tingkat_pendidikan') == 'S3')>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nomor_paspor" name="nomor_paspor" value="{{ old('nomor_paspor') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('tempat_dikeluarkan') }}" placeholder="Tempat dikeluarkan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_dikeluarkan') }}" placeholder="Tanggal dikeluarkan">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date"
                                        ...
                                        value="{{ old('tanggal_kadaluarsa') }}" placeholder="Tanggal Kadaluarsa">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('nama_keluarga_terdekat') }}" placeholder="Nama Keluarga Terdekat">
