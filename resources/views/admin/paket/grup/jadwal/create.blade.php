                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('nama_agenda') is-invalid @enderror"
                                        id="nama_agenda" name="nama_agenda" value="{{ old('nama_agenda') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('lokasi') is-invalid @enderror"
                                        id="lokasi" name="lokasi" value="{{ old('lokasi') }}" placeholder="Lokasi">
                                    @error('lokasi')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local"
                                        ...
                                        name="waktu_mulai" value="{{ old('waktu_mulai') }}" placeholder="Waktu Mulai">
                                    @error('waktu_mulai')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <a href="/admin/grup/{{ $grup->id }}/jadwal"
