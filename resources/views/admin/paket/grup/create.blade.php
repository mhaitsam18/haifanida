        ...
        <div class="col-lg-12 col-xl-12 stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/grup" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('agen_id') is-invalid @enderror" id="agen_id"
                                        ...
                                        @foreach ($agens as $agen)
                                            <option value="{{ $agen->id }}" @selected($agen->id == old('agen_id'))>
                                                {{ $agen->user->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_grup') is-invalid @enderror"
                                        id="nama_grup" name="nama_grup" value="{{ old('nama_grup') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('ketua_grup') is-invalid @enderror"
                                        id="ketua_grup" name="ketua_grup" value="{{ old('ketua_grup') }}"
                                        placeholder="Ketua Grup">
                                    @error('ketua_grup')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('status_grup') is-invalid @enderror"
                                        id="status_grup" name="status_grup" value="{{ old('status_grup') }}"
                                        placeholder="Status Grup">
                                    @error('status_grup')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('kuota_grup') is-invalid @enderror"
                                        id="kuota_grup" name="kuota_grup" value="{{ old('kuota_grup') }}"
                                        placeholder="Kuota Grup">
                                    @error('kuota_grup')
                                        <div class="text-danger fs-6">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('keterangan_grup') is-invalid @enderror" id="keterangan_grup"
                                        name="keterangan_grup" placeholder="Keterangan Grup">{{ old('keterangan_grup') }}</textarea>
                                ...
                                <a href="/admin/{{ $paket ? 'paket/' . $paket->id . '/' : '' }}grup"
