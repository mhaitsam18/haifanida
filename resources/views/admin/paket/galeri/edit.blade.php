    ...
    <div class="grid gap-6 lg:grid-cols-3">
        <x-card class="lg:col-span-2">
            <form action="/admin/galeri/{{ $galeri->id }}" method="post" enctype="multipart/form-data">
                ...
                <x-form-input label="Nama" name="nama" :value="old('nama', $galeri->nama)" placeholder="Nama" />
                <x-form-textarea label="Deskripsi" name="deskripsi" :value="old('deskripsi', $galeri->deskripsi)" placeholder="Deskripsi" />
                ...
                <div class="flex justify-end gap-2">
                    <x-button variant="secondary" :href="'/admin/paket/' . $galeri->paket_id . '/galeri'">Kembali</x-button>
        ...
        <x-card title="Pratinjau">
            <img src="{{ asset('storage/' . $galeri->file_path) }}" class="img-preview aspect-4/3 w-full rounded-lg object-cover">
        </x-card>
    </div>
@endsection
