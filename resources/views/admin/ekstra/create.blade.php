...
@section('content')
    ...
    <x-card class="lg:w-2/3">
        <form action="/admin/ekstra" method="post">
            @csrf
            <x-form-input label="Nama Ekstra" name="nama_ekstra" :value="old('nama_ekstra')" placeholder="Nama Ekstra" />
            <x-form-input label="Harga Default / Harga Bawaan" name="harga_default" :value="old('harga_default')" placeholder="Harga Default / Harga Bawaan" />
            ...
            <div class="mb-4">
                ...
                <select id="jenis_ekstra" name="jenis_ekstra"
                    ...
                    <option value="permintaan kamar" @selected(old('jenis_ekstra') == 'permintaan kamar')>Permintaan Kamar</option>
