                        ...
                        <div class="row">
                                    ...
                                    <div class="text-center position-relative">
                                        <div class="profile-photo-container mb-4">
                                            <img src="{{ $user->photo ? asset('storage/' . $user->photo) : asset('storage/user-photo/not-found.jpg') }}"
                                                class="rounded-circle border shadow-sm" alt="Profile Photo"
                                                style="width: 200px; height: 200px; object-fit: cover;">
                                        </div>

                                        <form action="{{ route('member.profile.update-photo') }}" method="POST"
                                ...
                                <div class="col-lg-8">
                                    <form action="{{ route('member.profile.update') }}" method="POST">
                                        ...
                                        <div class="mt-4 d-flex gap-3">
                                            ...
                                            <a href="{{ route('member.profile', ['mode' => 'show']) }}"
                                                class="btn btn-light btn-lg px-4 rounded-pill shadow-sm">
                            ...
                            @else
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="mt-4 d-flex gap-3">
                                        <a href="{{ route('member.profile', ['mode' => 'edit']) }}"
                                            class="btn btn-primary btn-lg px-4 rounded-pill shadow-sm">
                                            <i class="fas fa-user-edit me-2"></i>Edit Profile
                                        </a>
                                        <a href="/member/identitas"
                                            class="btn btn-light btn-lg px-4 rounded-pill shadow-sm">
