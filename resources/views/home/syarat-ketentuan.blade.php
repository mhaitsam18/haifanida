...
@php
    $sections = [
        ['id' => 'pendaftaran', 'label' => 'A. Syarat Pendaftaran'],
        ['id' => 'pembayaran', 'label' => 'B. Pembayaran & Pembatalan'],
        ['id' => 'perjalanan', 'label' => 'C. Selama Perjalanan'],
        ['id' => 'visa', 'label' => 'D. Ketentuan Visa'],
        ['id' => 'paket', 'label' => 'E. Paket & Layanan'],
        ['id' => 'keterlambatan', 'label' => 'F. Keterlambatan Pembayaran'],
        ['id' => 'force-majeure', 'label' => 'G. Force Majeure'],
        ['id' => 'hukum', 'label' => 'H. Pernyataan Hukum'],
        ['id' => 'website', 'label' => 'I. Website & Sistem Informasi'],
    ];
@endphp

@section('content')
    <x-legal-page :title="$title"
        subtitle="Mohon baca dengan saksama sebelum mendaftar perjalanan bersama kami."
        :sections="$sections">

        <h3>Syarat dan Ketentuan Umroh</h3>
        <p>Untuk kenyamanan dan kelancaran ibadah, setiap calon jamaah yang mendaftar bersama PT. Haifa Nida Wisata Karawang wajib memahami dan menyetujui syarat dan ketentuan berikut:</p>

        <div id="pendaftaran" data-legal-section>
        ...
        <div id="pembayaran" data-legal-section>
        ...
        <div id="visa" data-legal-section>
        ...
        <div id="paket" data-legal-section>
        ...
        <div id="keterlambatan" data-legal-section>
        ...
        <div id="force-majeure" data-legal-section>
        ...
        <div id="hukum" data-legal-section>
            <h4>H. Pernyataan Hukum</h4>
            <p>Dengan mendaftar atau menggunakan layanan, Anda dianggap setuju dengan syarat dan ketentuan ini. Kami berhak memperbarui isi peraturan yang disebabkan regulasi atau kondisi di luar kendali kami.</p>
            <p>Kami tidak bertanggung jawab atas perubahan informasi atau ketidaksesuaian akibat perubahan kebijakan. Semua isi situs dan promosi bersifat tidak mengikat secara hukum.</p>
        ...
        <div id="website" data-legal-section>
            <h4>I. Ketentuan Website, Aplikasi, dan Sistem Informasi</h4>
            <p>Seluruh konten pada situs web, aplikasi, dan sistem informasi kami, termasuk namun tidak terbatas pada teks, gambar, logo, desain, kode program, dan basis data, adalah milik PT. Haifa Nida Wisata Karawang atau mitra resmi kami, dan dilindungi oleh <strong>Undang-Undang Nomor 28 Tahun 2014 tentang Hak Cipta</strong>. Nomor dan Tanggal Permohonan: <strong>EC002025071030, 19 Juni 2025</strong>, Nomor Pencatatan: <strong>000911291</strong>. Website ini diumumkan pertama kali pada 24 Maret 2022. Dilarang menyalin, mendistribusikan, memodifikasi, atau menggunakan konten tersebut tanpa izin tertulis dari kami.</p>
            <p>Dengan mengakses situs atau aplikasi kami, Anda setuju untuk tidak menggunakannya untuk tujuan yang melanggar hukum, merugikan pihak lain, atau merusak reputasi perusahaan. Kami berhak membatasi atau menghentikan akses Anda apabila ditemukan pelanggaran.</p>
            <p>Kami tidak bertanggung jawab atas kerugian, kerusakan, atau gangguan layanan yang diakibatkan oleh hal-hal di luar kendali kami, termasuk namun tidak terbatas pada bencana alam, gangguan teknis, serangan siber, atau tindakan pihak ketiga. Untuk keamanan tambahan, Anda disarankan memiliki perlindungan asuransi perjalanan dan menggunakan perangkat yang aman.</p>
            <p>Anda bertanggung jawab penuh untuk menjaga kerahasiaan akun dan kata sandi yang digunakan untuk mengakses layanan online kami. Jangan membagikan informasi login kepada pihak lain. Kami menerapkan langkah-langkah keamanan sesuai <strong>Undang-Undang Nomor 27 Tahun 2022 tentang Perlindungan Data Pribadi</strong> dan <strong>Undang-Undang Nomor 11 Tahun 2008 tentang Informasi dan Transaksi Elektronik</strong> beserta perubahannya. Segera hubungi kami jika Anda mencurigai adanya akses tidak sah pada akun Anda.</p>
        </div>
    </x-legal-page>
@endsection
