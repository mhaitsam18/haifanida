...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/img/logo/logo_compressed.png">
    <link rel="icon" type="image/png" sizes="192x192" href="/img/logo/logo_compressed.png">
    {{-- <link rel="icon" type="image/png" sizes="32x32" href="/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/img/favicons/favicon-16x16.png"> --}}
    <link rel="manifest" href="/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/img/logo/logo_compressed.png">
